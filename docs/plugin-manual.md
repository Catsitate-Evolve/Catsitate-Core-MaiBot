...
- v0.9.0(2026-09-02):**说说详情工具与 reply 全域化**(view_friend_feed_detail 完整评论查看(楼中楼展开/Q9 上限/查看即已见)/qzone_reply 全域+comment_map 三级解析/view_friend_feeds 页码翻页/浏览注入带评论区(零新增 API)/删 recent_comments 死字段与 routing.py 死代码,见 §3.13),即当前公测版本。
...
| discovery_count | 50 | 发现层单页拉取条数(统一时间线;M3-r2 翻页) |
| discovery_max_pages | 3 | 发现层翻页上限(长时间离线后的积压补全;稳态首页全旧即止步恒 1 次调用) |
