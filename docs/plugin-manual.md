...
- v0.8.4(2026-09-02):截断清理与回执语义(回注/登记截断全删(用户逐项裁定)/见闻叙事 100 字/-10049 频控回执/get_by_time list 兼容,见 §3.13),即当前公测版本。
